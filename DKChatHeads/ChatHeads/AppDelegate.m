...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    UIBarButtonItem *leftItem = [[UIBarButtonItem alloc]initWithTitle:@"Chat" style:UIBarButtonItemStyleBordered target:self action:@selector(didTapLeftItem:)];
    self.viewController.navigationItem.leftBarButtonItem = leftItem;
...
- (void)draggingCoordinator:(CHDraggingCoordinator *)coordinator didDismissDraggableView:(CHDraggableView *)draggableView
{
    NSLog(@"didDismissDraggableView");
